...
sighandler_t signalHandler (void)
{
        ...
        cout<<"--------------------------------------------------------------------------------"<<endl;
        cout<<" Continue con la ultima instruccion que ejecuto"<<endl;
}
...
void inicioSesion(int id, int pG, int pC, string pipeC,int pid) {
        int c;
        string message;
        ...
        message=dLectura.message;
        if(message == "asincrono")
                opciones = 1;
...
int menu( int fdG, int fdC, int id, string pipeC)
{
        ...
        {       cout<<"--------->Cerrando Sesion...  ";
                ...
                if(write(fdG, &usuario, sizeof(usuario))==-1) {
                        perror("Escritura para cerrar sesion usuario:");
                        exit(0);
                }
...
int main(int argc, char **argv)
{
        ...
        inicioSesion(atoi(argv[1]),pipeG,pipeC,nompipeGC,pid);
        ...
        do {
                temp = menu(pipeG, pipeC, argv1,nompipeGC);
